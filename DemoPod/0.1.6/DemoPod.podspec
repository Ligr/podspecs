...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ligr/DemoPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ligr' => 'aliaksandr.huryn@cellpointmobile.com' }
  s.source           = { :git => 'https://github.com/Ligr/DemoPod.git', :tag => s.version.to_s }
